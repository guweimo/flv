...
def gua_image_encode(image_file, image_gua):
    # image_file = 'static/bbb/big_buck_bunny_00033.png'
    # image_gua = 'big_buck_bunny_00033.guaimage'
    image = Image.open(image_file)
    with open(image_gua, 'wb') as f:
        # 二进制 8
...
def gua_image_decode():
    image_gua = 'big_buck_bunny_00033.guaimage'
    with open(image_gua, 'rb') as f:
